...
/// A real 2048-bit RSA keypair (`e = 65537`) for the deployment-width
/// fixture — same validity requirement as the 512-bit pair.
const N_2048: [u8; 256] = [
...
/// The paired 2048-bit secret exponent — exported for the taint
/// harness, same as [`D_512`].
